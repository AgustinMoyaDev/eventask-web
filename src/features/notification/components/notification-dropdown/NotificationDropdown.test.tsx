...
vi.mock('@/features/notification/store/hooks/useNotificationMutations')
vi.mock('@/features/notification/store/hooks/useNotificationQueries')

import { useNotificationMutations } from '@/features/notification/store/hooks/useNotificationMutations'
import { useNotificationQueries } from '@/features/notification/store/hooks/useNotificationQueries'

vi.mock('@/features/notification/components/notification-list/NotificationList', () => ({
