...
import { useInvitationMutations } from '@/features/invitation/store/hooks/useInvitationMutations'
...
vi.mock('@/features/invitation/store/hooks/useInvitationMutations')
...
describe('InvitationDetailView', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(useInvitationMutations).mockReturnValue(valueMockInvitationActions)
  })
  ...
  it('disables buttons and shows loading text when accepting', () => {
    vi.mocked(useInvitationMutations).mockReturnValue({
